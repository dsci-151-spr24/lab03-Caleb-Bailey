...
***There are 935 rows and 26 columns in the nobel dataset. Each row represents a nobel winner. ***
...
ggplot(data = nobel_living_science, aes(y=country_us)) + geom_bar() +
  facet_wrap(~category)
...
ggplot(data = nobel_living_science, aes(y=country_us, fill=born_country_us)) + geom_bar() +
  facet_wrap(~category)
...
***The data does appear to support the articles claim as it shows that a number of nobel laureates were born in other countries other than the US. ***
